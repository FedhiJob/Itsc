    ...
    <footer className="border-t border-border bg-foreground text-white">
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.3fr_1fr_1fr_1.2fr] lg:px-8">
        <div>
          ...
          <p className="mt-2 text-sm italic leading-6 text-white/60">
        ...
        <div>
          <p className="text-sm font-semibold uppercase tracking-wide text-white/60">Follow Us</p>
          <div className="mt-4 flex flex-wrap gap-3">
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-md bg-white/10 text-white/75 transition-colors hover:bg-brand-gold hover:text-gray-900"
            >
          ...
          <p className="mt-6 text-sm font-semibold uppercase tracking-wide text-white/60">
            Subscribe
          </p>
          ...
          >
            ...
            <input
              ...
              className="min-w-0 flex-1 rounded-md border border-white/20 bg-white/10 px-3 py-2 text-xs text-white placeholder:text-white/40 focus:border-brand-gold focus:outline-none focus:ring-1 focus:ring-brand-gold"
            />
            <button
              type="submit"
